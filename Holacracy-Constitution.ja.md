...
*ロール*の*ロールリード*を務める*パートナー*は、その*ロール*の内部*サークル*内の ***サークルリードロール(Circle Lead Role)*** に自動的に就きます。すなわち、その立場で行動している間、 ***サークルリード(Circle Lead)*** となります。*サークルリードロール*の定義は、付録Aで与えられます。*サークル*の*ポリシー*で特に指定されていない限り、*親サークル*のない*サークル*には*サークルリード*がありません。
